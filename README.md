...
~~~sh
# getting the code
git clone git@github.com:nko5/farhadi.git && cd ./farhadi/
...
# deploying to Modulus (to http://farhadi.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/farhadi" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
